  ...
  <div class="grow flex flex-col gap-2">
    <PanelHeader title="Buy">
      <button
        ...
        @click="viewRoutes"
        type="button"
        class="cursor-pointer p-1 hover:bg-orange-100 rounded-full text-orange-800 hover:text-orange-700"
      >
        <Icon
          icon="fluent:book-exclamation-mark-24-regular"
          class="w-6 h-6"
        />
      </button>
    </PanelHeader>
    <form
      class="grow flex flex-col space-y-2 gap-2"
      @submit="getQuotes"
    >
      ...
      <div class="grow flex flex-col w-full justify-center gap-4">
        ...
        <div class="mt-4 flex gap-2 items-center">
          ...
          <button
            ...
            class="bg-blue-500 text-white rounded-full p-2 px-4 hover:bg-blue-600 flex items-center justify-center gap-2"
            type="button"
            @click="open()"
          >
            <Icon
          ...
          <button
            v-else
            class="bg-red-300 text-white rounded-full p-2 px-4 hover:bg-red-400 flex items-center justify-center gap-2"
            type="button"
