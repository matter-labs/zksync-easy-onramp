<template>
  <div
    class="border border-gray-200 rounded-2xl shadow-xl w-panel-width relative h-panel-height"
  >
    <div
      class="absolute inset-0 p-4 flex flex-col justify-stretch items-stretch"
    >
